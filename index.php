	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#resume-section" class="nav-link"><span>Curriculum Vitae</span></a></li>
	          <li class="nav-item"><a href="#services-section" class="nav-link"><span>Portfolio</span></a></li>
    		...
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/thibaut.jpg);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>Etudiant en BAC 3 en technologie de l'informatique à l'EPHEC de Louvain-la-neuve. Je suis également étudiant-entrepreneur et j'ai lancé ma start-up, Wecodx, en mai 2019</p>
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Nom:</span> <span>Thibaut Hermant</span></li>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-3">
				    <nav id="navi">
					    <ul>
					      <li><a href="#page-1">Formation</a></li>
					      <li><a href="#page-2">Experience</a></li>
					      <li><a href="#page-3">Competences</a></li>
					      <li><a href="#page-4">Centre d'interêt</a></li>
					    </ul>
					  </nav>
					</div>
					<div class="col-md-9">
					  <div id="page-1" class= "page one">
					    ...
					    <div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Technologie de l'informatique</h2>
		    					<span class="position">Ephec Louvain-la-Neuve</span>
		    					<p>Obtention d'un Bachelier en technologies de l'informatique</p>
	    					</div>
	    				</div>
	    				<div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Diplome CESS</h2>
		    					<span class="position">Collège Saint Joseph Chimay</span>
		    					<p>Etudes Secondaire au collèges saint-Joseph de Chimay - Option Informatique </p>
		    				</div>
	    				</div>
					  </div>
					  ...
					  <div id="page-2" class= "page two">
						...
						<div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Etudiant-entrepreneur</h2>
		    					<span class="position">Wecodx</span>
		    					<p>J'ai lancé ma start-up, Wecodx, en mai 2019 en tant qu'étudiant-entrepreneur.<br> Réalisation de sites web, applications mobiles, plateformes, ...</p>
		    				</div>
	    				</div>
					    <div class="resume-wrap d-flex ftco-animate">
					    	<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					<span class="date">Aout 2018</span>
		    					<h2>Facteur Bpost</h2>
		    					<span class="position">Région de Chimay</span>
		    					<p>Facteur dans la région de Chimay durant le mois d'aout 2018</p>
		    				</div>
						</div>
						<div class="resume-wrap d-flex ftco-animate">
					    	<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Ouvrier</h2>
		    					<span class="position">Froidchapelle</span>
		    					<p>Construction de maison structure bois, parquet, maçonnerie, betonnage, ...</p>
		    				</div>
	    				</div>
	    				<div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Ouvrier</h2>
		    					<span class="position">Froidchapelle</span>
		    					<p>Employé en tant qu'ouvrier pour bucheronnage, parquet, jardinerie, ...</p>
		    				</div>
	    				</div>
					  </div>
					  ...
					  <div id="page-4" class= "page four">
					    <h2 class="heading">Centres d'interêt</h2>
					    <div class="resume-wrap d-flex ftco-animate">
					    	<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Volleyball</h2>
		    					<span class="position">Froidchapelle | Chaumont-Gistoux</span>
		    					<p>Je suis passionné de volley depuis l'age de mes 5 ans</p>
	    					</div>
	    				</div>
	    				<div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Cyclisme</h2>
		    					<span class="position">Froidchapelle</span>
		    					<p>Je pratique le cyclisme sur route depuis l'âge de mes 10 ans</p>
		    				</div>
	    				</div>
	    				<div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Informatique</h2>
		    					<span class="position">Froidchapelle | Chimay</span>
		    					<p>J'ai découvert l'informatique en 5ème année au collège saint Jospeh</p>
		    				</div>
	    				</div>
					  </div>
					</div>
    ...
    <section class="ftco-section" id="services-section">
    	...
    	<div class="row justify-content-center py-5 mt-5">
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>Voici un tableau récapitulatif de mes activitées réalisées liées à l'informatique durant ces 3 dernières années</p>
          </div>
		</div>
      ...
      <div class="container">
          ...
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box text-center p-4 shadow">
          		...
          		<div>
		            ...
		            <p><a href="tel:+32492869516">+ 32 492 86 95 16</a></p>
	            </div>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box text-center p-4 shadow">
          		...
          		<div>
		            ...
		            <p><a href="mailto:thibaut@wecodx.com">thibaut@wecodx.com</a></p>
		          </div>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box text-center p-4 shadow">
          		...
          		<div>
		            ...
		            <p><a href="https://www.wecodx.com">wecodx.com</a></p>
	            </div>
	          </div>
          </div>
        </div>
        ...
        <div class="row no-gutters block-9">
          ...
          <div class="col-md-6 d-flex">
          	<div class="img" style="background-image: url(images/thibaut.jpg);"></div>
          </div>
        </div>
      </div>
    </section>
